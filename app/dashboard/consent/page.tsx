...
import { getConsentPreferences, updateConsentPreferences } from '@/lib/api';
...
export default function ConsentPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const preferencesData = await getConsentPreferences();
        setPreferences(preferencesData);
        setTempPreferences(preferencesData);
      } catch (error) {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const updated = await updateConsentPreferences(tempPreferences);
  ...
  if (!preferences || !tempPreferences) {
    return (
      <DashboardLayout>
        <div className="flex items-center justify-center h-full">
          <p className="text-gray-500">Failed to load consent preferences</p>
        </div>
      </DashboardLayout>
    );
  }
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className="font-semibold text-gray-900">Employer Access</h4>
            ...
            <div className="rounded-lg border border-gray-200 p-4">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className="font-semibold text-gray-900">Aggregated Data Sharing</h4>
        ...
        <Card>
          <div className="space-y-4">
            <div className="flex items-start gap-3 rounded-lg bg-blue-50 p-4">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-blue-900">How Your Data is Protected</h4>
